(function () {
  ...
  function runComparison() {
    ...
    if (breakEvenMonth != null) {
      breakEvenEl.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="break-even-icon"><circle cx="12" cy="12" r="10"></circle><polyline points="12 16 16 12 12 8"></polyline><line x1="8" y1="12" x2="16" y2="12"></line></svg>
        <div>
          <strong>Refinance cost break-even at month ${breakEvenMonth}</strong> <br>
          <span style="font-size: 0.9em">(cumulative interest savings cover the refinance cost).</span>
        </div>
      `;
  ...
  // Run the default comparison on page load
  runComparison();
})();
